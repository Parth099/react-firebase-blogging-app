...
import SquareSpinnerHOC from "../../components/SquareSpinnerHOC";
...
export default function EditBlogPost() {
    ...
    const URLInfo = router.query;
    const blogID = URLInfo.blogID as string;
    ...
    useEffect(() => {
        if (!storageContext?.getDocDataById || blogID === "undefined") return;
    ...
    const handlePostEdit = () => {
        ...
        //cant be empty
        if (!newContent || !blogID) return;

        //send update via context, easier to have it search by id
        storageContext!
            .updateDocumentById(blogID, {
                content: newContent,
                blogTags,
            })
